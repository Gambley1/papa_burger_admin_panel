...
import 'package:papa_burger_admin_panel/src/models/restaurant/place.dart';
import 'package:papa_burger_admin_panel/src/models/restaurant/restaurant_details.dart';
...
class Restaurant {
  ...
  factory Restaurant.fromMap(Map<String, dynamic> json) {
    return Restaurant(
      businessStatus: json['business_status'] as String,
      name: json['name'] as String,
      openingHours: const OpeningHours.opened(),
      placeId: json['place_id'] as String,
      tags: List<Tag>.from(
